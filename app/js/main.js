...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentAppJsx = __webpack_require__(160);

	var _componentAppJsx2 = _interopRequireDefault(_componentAppJsx);

	_reactDom2['default'].render(_react2['default'].createElement(_componentAppJsx2['default'], null), document.getElementById('app'));
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'h1',
	          null,
	          'Hello this is git profile viewer app'
	        )
	      );
	    }
	  }]);
